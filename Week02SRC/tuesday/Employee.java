...
public class Employee {
	...
	//create constructors at the top and this is for changing from using the default constructor. also child classes don't have access to the parent custom constructor (they have access to the default constructor though)
